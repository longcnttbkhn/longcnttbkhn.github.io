...
Trước khi vào nội dung của bài viết mình xin phép mọi người 1 phút. Hiện tại mình đang phát triển nền tảng phân tích dữ liệu và chia sẻ Insight Blockchain có tên là [chainslake](https://chainslake.com/public/local). Mục tiêu của mình là xây dựng cộng đồng chuyên gia phân tích dữ liệu Blockchain tại Việt Nam, cùng nhau khai thác Data warehouse blockchain để giải quyết các bài toán về phân tích, tìm kiếm Insight, truy vết giao dịch... Đây là link [tài liệu](https://chainslake.github.io/hoc-phan-tich-du-lieu-lam-insight-blockchain-cung-chainslake/) của dự án, rất mong nhận được sự ủng hộ từ các bạn. 
